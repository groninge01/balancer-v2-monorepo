...
contract ReaperLinearPool is LinearPool {
     ...
     * -----------
     * Internally, the LinearPool scales all balances and rates up to 18 decimal places, meaning that 1 USDC is represented as 1e18 by the LinearPool.
     * Since the rfUSDC is already 18 decimals, but in a different representation, we need to account for that in our wrappedTokenRate.
     */
